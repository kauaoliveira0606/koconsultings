...
export async function GET(request: NextRequest) {
  ...
  // resort — same preference the Weekly Scorecard uses, so this and the
  // scorecard's week total agree instead of the form silently under-
  // counting whenever nobody re-types the real number into it.
