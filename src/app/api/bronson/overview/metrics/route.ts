...
export async function GET(request: NextRequest) {
  ...
  // actually collected cash for them, matched by email via Affiliate PCN.
  // Post Call Note has no lead-email field on this offer, so it can't be
  // matched the same way — this only covers the low-ticket affiliate motion.
