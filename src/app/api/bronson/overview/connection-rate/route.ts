...
import { getLeads, getConnectedCalls } from "@/lib/airtable/tables";
...
/**
 * First Eastern day the "Base44 Paid" / "Base44 Organic" GHL tags were being
 * applied to new opt-ins. Pickups are matched to Paid/Organic by that tag, so
 * anything before this date has opt-ins but no way to attribute a pickup —
 * counting those days would only drag both rates toward 0%.
 */
export const CONNECTION_TRACKING_START = "2026-09-20";
